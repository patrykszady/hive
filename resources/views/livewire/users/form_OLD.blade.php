<x-modals.modal :class="'max-w-lg'">
    <form wire:submit.prevent="{{$view_text['form_submit']}}"> 
        ...
        <x-cards.body :class="'space-y-4 my-4'">
            ...
            <div 
                ...
                @if(isset($this->via_vendor->new))
                    ...
                    <x-forms.row 
                        ...
                        <option value="" readonly>Business Type</option>
            ...
            <div 
                x-data="{ open: @entangle('via_vendor.business_name'), vendor_user_form: @entangle('vendor_user_form') }" 
                ...
                <x-forms.row 
                    ...
                    text="User Role"
                    type="dropdown"
                    :disabled="$user_vendor_id == 'NEW' ? true : false"
                    autofocus
                    >
